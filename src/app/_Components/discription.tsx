...
export const Discription = () => {
  return (
    <div className="w-full h-66 flex flex-col gap-4 p-5 lg:absolute lg:w-101 lg:h-66 lg:text-[#FFFFFF] lg:top-60 lg:left-35 lg:p-0 lg:justify-evenly">
      ...
      <div className="text-sm text-[#09090B] lg:text-[#FAFAFA] lg:w-76 lg:text-xs">
      ...
      <Button className="px-4 py-2 w-36 h-10 flex gap-2 bg-[#18181B] lg:bg-[#F4F4F5] lg:hover:bg-[#d0cfcf] ">
        <Play className="size-4 text-[#FAFAFA] lg:text-[#18181B]" />
        <h3 className="text-sm font-medium text-[#FAFAFA] lg:text-[#18181B]">
          Watch Trailer
        </h3>
      </Button>
    </div>
